			    ...
			    <div class="span4">
					...
					<?php 
						...
						array(
							...
							'update'=>'#DriverZhaopin_district_id', //selector to update
							'data'=>array('city_id'=>'js:$("#DriverZhaopin_city_id").val()')
							))
						);
...
<?php
	...
	$this->widget('CJuiDateTimePicker', array (
		'name'=>'DriverZhaopin[driver_year]', 
...
<script language="javascript">
  ...
  $(document).ready(function(){
    ...
    $('.checkallcars').click(function () {
      $("input[id^='DriverZhaopin_driver_cars']:not([disabled='disabled'])").attr('checked', this.checked);
    });
  });
</script>
</div>
...
<div class="span12">
<div class="page-header">
<h2>6.请阅读并同意<a href="/agreement" target="_blank">《e代驾代驾协议》</a></label></h2>
</div>
</div>
</div>
<div class="row-fluid">
...
<p>1.以上填写的信息属实，提供的证件真实有效，一旦被发现有不属实的地方，愿意接受任何处理，甚至被辞退。</p>
<p>2.确认与公司的合作出于自愿，接受服务信息，获得合作利益的同事依法履行合作的义务。</p>
</div>
</div>
</section>
