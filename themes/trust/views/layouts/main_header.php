...
//bootstrap-modal.js
$cs->registerScriptFile(SP_URL_IMG.'bootstrap/js/bootstrap-modal.js',CClientScript::POS_END);
    ...
    <div class="navbar-inner">
      <div class="container">      
		...
		<div class="nav-collapse collapse">
            <ul class="nav">
				<li class="">
                <a href="/v2" style="padding:0px"><img src="<?php echo SP_URL_IMG;?>logo.gif" style="padding:0px;height:40px;margin: -2px 0px;"></a>
              </li>
            </ul>
          </div>
      </div>
