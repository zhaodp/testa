...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);"><?echo date('m', strtotime($date_time));?>月汇总</a></li>
</ul>
<div class="row-fluid">
    <table class="table table-bordered table-striped">
        ...
        foreach ($data as $v) {
            $arr = array(
                'ReportFsAccountRp[city_id]' => 0,
                'ReportFsAccountRp[account_date]' => $v->daily_date
            );
            $url = Yii::app()->createUrl('/finance/daily_account', $arr);
