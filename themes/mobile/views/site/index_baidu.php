    ...
    <div class="main_box clearfix">
        ...
        <div class="AearR">
            ...
            <ul class="ddl" style="display:none;">
                ...
                <li><a href="javascript:;" id="city_list_76" onclick="city_sel(3,76)">湛江</a></li>
                <li><a href="javascript:;" id="city_list_16" onclick="city_sel(5,74)">丽水</a></li>
                <li><a href="javascript:;" id="city_list_16" onclick="city_sel(5,73)">连云港</a></li>
                <li><a href="javascript:;" id="city_list_16" onclick="city_sel(5,75)">盐城</a></li>
                <li><a href="javascript:;" id="city_list_16" onclick="city_sel(5,47)">泰州</a></li>
                <li><a href="javascript:;" id="city_list_16" onclick="city_sel(5,65)">唐山</a></li>
            </ul>
		...
		<dl id="time5" style="display:none;">
                    <dd><span style='width:120px;'>时间段</span><span style='width:84px;'>代驾费</span></dd>
                    <dd><span style='width:120px;'>07:00—21:59</span><span style='width:84px;'>29元</span></dd>
                    <dd><span style='width:120px;'>22:00—06:59</span><span style='width:84px;'>39元</span></dd>
                </dl>
                <div class="blank0"></div>
                <p>&nbsp;</p>
...
满30分钟不收费。
		 ...
		 <pre id="beizhu5" style="display:none;"><b>注：</b>
1、不同时段的代驾起步费以实际出发
时间为准。
2、代驾距离超过10公里后，每5公里
加收20元，不足5公里按5公里计算。
