...
<div class="row-fluid">
   <div class="span3">
       ...
       <?php echo $form->textField($model,'base_qname', array('size'=>60,'maxlength'=>255,'readonly'=>"readonly")); ?>
       <?php echo $form->error($model,'base_qname'); ?>
   </div>

   <div class="span3">
       <?php echo $form->labelEx($model,'hash_qname'); ?>
       <?php echo $form->textField($model,'hash_qname', array('size'=>60,'maxlength'=>255,'readonly'=>"readonly")); ?>
       <?php echo $form->error($model,'hash_qname'); ?>
   </div>
