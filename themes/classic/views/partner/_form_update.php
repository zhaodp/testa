            ...
            <div class="span9">
                ...
                <div class="span3">
                    <div class="row-fluid">
                        ...
                        <?php echo $form->textField($model,'seat_number',array('size'=>11,'maxlength'=>11, 'readonly' => 'readonly')); ?>
    ...
    <div class="hero-unit" style="padding: 10px;margin-bottom: 20px">
        ...
        <div class="row-fluid">
            <div class="span9">
                <div class="span3">
                    <div class="row-fluid">
                        <?php echo CHtml::dropDownList('user_pay_sort', $model->pay_sort == 1 ? 2 : 1, $paySort)?>
                    </div>
                </div>
                <div class="span3" id="pay_method" <?php echo $model->pay_sort == 1 ? 'style="display:none;"': '';?>>
                    <?php
                        if($model->pay_sort == 2){
                            echo '<div class="span3">';
                                echo '<div class="row-fluid">';
                                    echo '<select id="user_pay_method" name="user_pay_method">';
                                        echo '<option value="0">请选择付费方式</option>';
                                        echo '<option value="1">VIP全额免单</option>';
                                        echo '<option value="2" selected="selected">优惠券减免</option>';
                                    echo '</select>';
                                echo '</div>';
                            echo '</div>';
                        }elseif($model->pay_sort == 3){
                            echo '<div class="span3">';
                                echo '<div class="row-fluid">';
                                    echo '<select id="user_pay_method" name="user_pay_method">';
                                        echo '<option value="0">请选择付费方式</option>';
                                        echo '<option value="1" selected="selected">VIP全额免单</option>';
                                        echo '<option value="2">优惠券减免</option>';
                                    echo '</select>';
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        <div class="row-fluid">
            <div class="span9" id="change_pay_sort" <?php echo $model->pay_sort == '' ? 'style="display:none;"': ''; ?>>
                <?php
                    if($model->pay_sort == 1){
                        echo  '<div class="span3">';
                            echo '<div class="row-fluid">';
                                echo $form->labelEx($model,'sharing_amount');
                                echo $form->textField($model,'sharing_amount',array('size'=>10,'maxlength'=>10));
                                echo $form->error($model,'sharing_amount');
                            echo '</div>';
                        echo '</div>';
                    }else if($model->pay_sort == 2){
                        echo '<div class="span3">';
                            echo '<div class="row-fluid">';
                                echo $form->labelEx($model,'bonus_sn');
                                echo $form->textField($model,'bonus_sn',array('size'=>30,'maxlength'=>30, 'bonus-sn-check' => 'yes'));
                                echo $form->error($model,'bonus_sn');
                            echo '</div>';
                        echo '</div>';
                        echo '<div class="span3">';
                            echo'<div class="row-fluid">';
                                echo $form->labelEx($model,'bonus_phone'/*, array('label' => '优惠券数量剩余 <span id="bonus_quantity_id">'.$model->bonus_quantity.'</span> 张')*/);
                                echo $form->textField($model,'bonus_phone', array('bonus-phone-check' => 'yes'));
                                echo $form->error($model,'bonus_phone');
                            echo '</div>';
                        echo '</div>';
                        echo '<div class="span6" id="check_bonus_status"></div>';
                        /*echo '<div class="span3">';
                            echo'<div class="row-fluid">';
                                echo $form->label($model, '&nbsp;');
                                echo CHtml::Button('充值', array('id' => 'bonus_recharge_btn', 'class' => 'btn', 'data-partner-id' => $model->id));
                            echo '</div>';
                        echo '</div>';*/
                    }else if ($model->pay_sort == 3){
                        echo '<div class="span3">';
                            echo '<div class="row-fluid">';
                            echo $form->labelEx($model,'vip_card');
                            echo $form->textField($model,'vip_card',array('size'=>11,'maxlength'=>11, 'vip-check' => 'yes'));
                            echo $form->error($model,'vip_card');
                            echo '</div>';
                        echo '</div>';
                        echo '<div class="span6" id="check_vip_status"></div>';
                    }
                ?>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span9" id="change_label" <?php echo $model->pay_sort == '' ? 'style="display:none;"': ''; ?>>
                <?php
                    if($model->pay_sort == 1){
                        echo '<div class="row-fluid">';
                            echo CHtml::checkBox('divided_confirm', array('checked' => 'checked'));
                            echo CHtml::label("请确认该合作商家将使用报单分成进行结算", "divided_confirm", array('class'=>'checkbox inline', 'style' => 'padding-left:0px;'));
                        echo '</div>';
                    }else if($model->pay_sort == 2){
                        echo '<div class="row-fluid">';
                            echo CHtml::checkBox('bonus_confirm', array('checked' => 'checked'));
                            echo CHtml::label("请确认该合作商家将使用此优惠劵减免", "bonus_confirm", array('class'=>'checkbox inline', 'style' => 'padding-left:0px;'));
                        echo '</div>';
                    }else if ($model->pay_sort == 3){
                        echo '<div class="row-fluid">';
                            echo CHtml::checkBox('vip_confirm', array('checked' => 'checked'));
                            echo CHtml::label("请确认该合作商家将使用此VIP账户结算", "vip_confirm", array('class'=>'checkbox inline', 'style' => 'padding-left:0px;'));
                        echo '</div>';
                    }
                ?>
            </div>
...
//        $("#change_label").hide();
            ...
            if(paySort == 1) {
                ...
                $("#change_pay_sort").html('<div class="span3">' +
                    '<div class="row-fluid">' +
                        ...
                        <?php echo $form->textField($model,'sharing_amount',array('size'=>10,'maxlength'=>10)); ?>
        ...
        * */
        $("#user_pay_method").live('change', function(){
            ...
            if(payMethod == 1){
                ...
                $("#change_pay_sort").html('<div class="span3">' +
                    ...
                    '</div>' +
                '</div>'+
                '<div class="span5" id="check_vip_status"></div>');
                ...
                $("#change_pay_sort").html('<div class="span3">' +
                    '<div class="row-fluid">' +
                        ...
                        <?php echo $form->textField($model,'bonus_sn',array('size'=>30,'maxlength'=>30, 'bonus-sn-check' => 'yes')); ?>
                        <?php echo $form->error($model,'bonus_sn'); ?>'+
                    '</div>' +
                '</div>'+
                   '<div class="span3">'+
                        '<div class="row-fluid">'+
                            '<?php echo $form->labelEx($model,'bonus_phone'/*, array('label' => '优惠券数量剩余 <span id="bonus_quantity_id">'.$model->bonus_quantity.'</span> 张')*/); ?>
                            <?php echo $form->textField($model,'bonus_phone', array('bonus-phone-check' => 'yes')); ?>
                ...
                <?php //echo CHtml::Button('充值', array('id' => 'bonus_recharge_btn', 'class' => 'btn', 'data-partner-id' => $model->id)); ?>'+
                '</div>'+
                '</div>'*/);
                    ...
                    'success':function(data){
                        if(data.status == 1){
                            ...
                            $('#check_vip_status').html(
                                '<div class="row-fluid">'+
                                    '<?php echo $form->label($model, '&nbsp'); ?>'+
                                    '<p class="text-error">VIP账户不存在，请重新输入或点击开通VIP</p>'+
                                '</div>');
                        }
                    }
                });
        ...
        $("#Partner_bonus_sn").live('blur', function(){
            ...
            if(bonusSn != ''){
                $.ajax({
                    ...
                    'success':function(data){
                        if(data.status == 0){
                            $("#Partner_bonus_sn").attr('data-check', 'no');
                        }else{
                            $("#Partner_bonus_sn").attr('data-check', 'yes');
                        }
                    }
                });
            }
        ...
        /*$("#bonus_recharge_btn").live('click', function(){
            var partner_id = $(this).attr('data-partner-id');
            var bonus_sn = $("#Partner_bonus_sn").val();
            var bonus_quantity = $("#Partner_bonus_quantity").val();
            var old_quantity = $("#bonus_quantity_id").text();
            $.ajax({
                'url':'<?php //echo Yii::app()->createUrl('/partner/isCheckVip');?>',
                'data':{'partner_id':partner_id, 'bonus_quantity':bonus_quantity, 'bonus':bonus_sn},
                'type':'get',
                'dataType':'json',
                'cache':false,
                'success':function(data){
                    if(data.status == 1){
                        $("#bonus_quantity_id").text(parseInt(old_quantity)+parseInt(bonus_quantity));
                        $("#Partner_bonus_quantity").val(parseInt(old_quantity)+parseInt(bonus_quantity))
                        alert(data.message);
                    }else{
                        alert(data.message);
                    }
