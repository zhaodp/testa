...
var options = {
  onSearchComplete: function(results){
    ...
    if(all_count>0){
        var lng = all_longtitude/all_count;
        var lat = all_latitude/all_count;
        $.get("index.php", 
			{
            	r :'client/nearby',
            	lng : lng,
            ...
            function(data){
            	...
            	for(var i=0; i<driver_list.length; i++) {
					...
					message = "";
					if (is_agent=="1") {
						message="【<a href='#' onclick='javascript:window.parent.softphoneBar.dialout("+ d.phone +");return false;'>呼叫司机</a>】&nbsp;&nbsp;&nbsp;&nbsp;"+ sms_link +"<br/>";
					}
					
					addDriver(d.lat, d.lng, d.driver_id, 0, message, d.recommand);
                }
...
map.addEventListener("load", addMarkers);
