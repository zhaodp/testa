                                ...
                                if (isset($m['sub'])) {
                                    ...
                                    foreach ($m['sub'] as $s) {
                                        ...
                                        if(isset($s['third'])){
                                            ...
                                            echo '<li class="' . $class . '"><a ' . $target . ' href="' . $s['app_url'] . '/' . $s['action_url'] . '"> ' . $s['name'] . '</a>
                                            ...
                                            foreach($s['third'] as $third){
                                                ...
                                                echo '<li ' . $class_sub . '><a ' . $target . ' href="' . $s['app_url'] . '/' . $s['action_url'] . '"> ' . $third['name'] . '</a></li>';
                                            }
                                            echo '</ul></li>';
                                        }else{
                                            echo '<li class="' . $class . '"><a ' . $target . ' href="' . $s['app_url'] . '/' . $s['action_url'] . '"> ' . $s['name'] . '</a></li>';
                                        }
...
if(Yii::app()->user->admin_level > AdminUserNew::LEVEL_NORMAL){
    echo "<li><a href=\"{$auth_url}\">权限管理</a></li>";
}
echo "
<li><a href=\"{$logout_url}\">退出</a></li>
</ul></li> 
...
<script>
    ...
    $(".dropdown-submenu,.dropdown-menu").on("mouseout",function(){
