...
<div class="btn-group">
    <?php echo CHtml::link('当月', array("order/orderStats", "Order"=>array("month"=>1)),array('class'=>"btn", 'id' => 'btn_now_month'));?>
    <?php echo CHtml::link('上月', array("order/orderStats", "Order"=>array("last_month" => 2)),array('class'=>"btn", 'id' => 'btn_last_month'));?>
</div>
    ...
    'columns'=>array (
        ...
        array (
            ...
            'buttons' => array(
                'order' => array(
                    'label' => '订单明细',
                    'url' => 'Yii::app()->createUrl("order/orderPartner", array("Order" =>array("channel"=>$data["channel"], "call_time" => "'.$call_time.'", "booking_time" => "'.$booking_time.'")))',
                    /*'click' => 'function(){
                    var url = $(this).attr("href");
                    $("#view_booking_frame").attr("src", url);
...
//            ),
//            'type'=>'raw',
//            'value'=>array($this, 'operateDetail')
