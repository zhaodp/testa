...
if(isset($model['id'])){
    ...
    $sms3 = isset($model['sms3']) ? $model['sms3'] : '';
    if(!empty($page_json)){
    ...
    <body>
        ...
        <form class="form-create">
            ...
            <div class="wrapper">
                ...
                <aside>
                    <h1>预览页面</h1>
                    <iframe id="previewIfr" src="<?php echo $static_host;?>/core/event_modules/module2/preview.html" width="320" height="568" ></iframe>
                    <p>
                        <label>选择页面: </label>
            ...
            <div class="wrapper">
                <section>
                    ...
                    <fieldset>
                        ...
                        <p><label>老客领过劵短信文案: </label>
                            <textarea required name="sms2"><?php if(!empty($sms2)){echo $sms2; }?></textarea>
                        </p>
                        <p><label>老客未领劵短信文案: </label>
                            <textarea required name="sms3"><?php if(!empty($sms3)){echo $sms3; }?></textarea>
                        </p>
                    </fieldset>
                    <fieldset>
                        <legend>财务统计</legend>
        ...
        <script type="text/javascript" src="<?php echo $static_host;?>/core/event_modules/module2/js/admin.js"></script>
    </body>
</html>