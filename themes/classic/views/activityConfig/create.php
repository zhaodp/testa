    ...
    <body>
        ...
        <form class="form-create">
            ...
            <div class="wrapper">
                ...
                <aside>
                    <h1>预览页面</h1>
                    <iframe id="previewIfr" src="<?php echo $static_host;?>/core/event_modules/module1/preview.html" width="320" height="568" ></iframe>
                    <p>
                        <label>选择页面: </label>
            ...
            <div class="wrapper">
                <section>
                    ...
                    <fieldset>
                        <legend>业务信息</legend>
                        <p><label>优惠券sn码: </label><input required name="bonus_sn" value="<?php echo $bonus_sn;?>"></p>
                        <p><label>优惠券数量: </label><input  required type="number" min="1" name="bonus_num"  value="<?php echo $bonus_num;?>" ></p>
                        <p><label>优惠券类型: </label>
                            <select class="json-item" data-item="couponType">
                                <option value="0" <?php if($act_sharpen == 0){echo 'selected'; }?>>不限新老客</option>
                                <option value="1" <?php if($act_sharpen == 1){echo 'selected'; }?>>新客使用</option>
                                <option value="2" <?php if($act_sharpen == 2){echo 'selected'; }?>>老客使用</option>
                            </select>
                        </p>
                        <p>
                            <label>活动开始时间: </label>
        ...
        <script type="text/javascript" src="<?php echo $static_host;?>/core/event_modules/common/js/admin.js"></script>
    </body>
</html>