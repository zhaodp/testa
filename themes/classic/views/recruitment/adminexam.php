...
<div class="btn-group">
	...
	<?php echo CHtml::link('添加试题', array("recruitment/createexam"),array('class'=>"btn"));?>
</div>
		...
		array(
			...
			'headerHtmlOptions'=>array (
				...
				'buttons'=>array(
						'update' => array(
								'label'=> '修改',
								'url'=>'Yii::app()->controller->createUrl("recruitment/updateexam",array("id"=>$data->id))',
								'click'=>$click_update,
						),
						'view' => array(
								'label'=> '查看',
								'url'=>'Yii::app()->controller->createUrl("recruitment/viewexam",array("id"=>$data->id))',
								'click'=>$click_view,
						),
				)
		),
...
function Dialogdivview(id){
	$.ajax({
		'url':'<?php echo Yii::app()->createUrl('/recruitment/viewexam');?>',
		'data':'id='+id,
		'type':'get',
...
function Dialogdivupdate(id){
	$.ajax({
		'url':'<?php echo Yii::app()->createUrl('/recruitment/updateexam');?>',
		'data':'id='+id,
		'type':'get',
		'success':function(data){
			$('#dialogdiv').html(data);
...
function ShieldorNormal(id,status){
	...
	if (status !==""){
		...
		$.ajax({
			'url':'<?php echo Yii::app()->createUrl('/recruitment/ajaxstatus');?>',
