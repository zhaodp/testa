...
&nbsp;
<?php echo CHtml::link('添加批次',Yii::app()->createUrl('recruitment/driverbatchcreate'),array('class'=>'btn'));?>
...
function driverZhaopinRecycle(batch){
	$.ajax({
		'url':'<?php echo Yii::app()->createUrl('/recruitment/driverZhaopinRecycle');?>',
		'data':'batch='+batch,
		'type':'get',
		'beforeSend':function(){
