...
$selVip_id = isset($_POST['vipcard'])? $_POST['vipcard'] : '';
...
<div class="row">
<div class="span12">
<p>卡号：<?php echo $Vip->vipcard;?> 主卡人姓名：<?php echo $Vip->name;?> 手机号码：<?php echo $Vip->phone;?> 余额：<?php echo $Vip->remain;?> 状态：<?php echo Vip::model()->arrStatus[$Vip->status];?></p>
</div>
</div>
<div class="row">
