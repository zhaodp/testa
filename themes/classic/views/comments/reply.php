...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="control-group">
		...
		<div class="controls">
			<input class='' readonly value='<?php echo $comments['driver_name'];?>'></input>
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php echo $form->textArea($model,'description',array('class'=>'span12','style'=>'width:500px;height:60px;')); ?>
	...
	<div class="control-group">
		<label class="control-label">屏蔽司机：</label>
		<div class="controls">
			<input type="checkbox" name="CommentsReply[comment_block]" id="CommentsReply[comment_block]" />
		</div>
	</div>
...
$criteria->params = array (
	':employee_id'=>$comments['employee_id']
);
