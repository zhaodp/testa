...
hojo.declare("icallcenter.SoftphoneBar", null, {
	...
	gateway_stSystemBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyDisable"],
	...
	Local_stSystemBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyDisable"],
    ...
    sip_stSystemBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyDisable"],
	...
	toConsult: function(num) {
    	icallcenter.hojotools.input("consult",num);
    },
	...
	exThreeWayCall: function(phoneNum) {
    	if (/^\d+$/.test(phoneNum)) {
    		icallcenter.hojotools.close('softphonebar'); 
    		phone.threeWayCall("9" + phoneNum, "external");
    	 } else {
    		 icallcenter.hojotools.error("请输入正确的电话号码");
    	 }       
    }
