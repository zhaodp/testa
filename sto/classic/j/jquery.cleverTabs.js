...
CleverTab.prototype.setLock = function (lock, changeOrgLock) {
    ...
    if (!lock) {
        ...
        this.header.append($('<a href="#" disable="false" class="ui-corner-all" title="Locked" style="position: absolute; cursor: pointer; padding: 0px; top: 1px; right: 1px"><span class="ui-icon ui-icon-locked"></span></a>'));
    }
}
//获取指定Tab头完全id的唯一id
