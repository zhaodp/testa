window.BMAP_AUTHENTIC_KEY = "011d533964c870fc9d33dd9e4cff886e"; (function() {
    var aa = void 0,
    i = !0,
    n = null,
    o = !1;
    ...
    t.cd = t.event.cd = function(a, b, c) {
        if (! (a = t.S(a))) return a;
        b = b.replace(/^on/, "");
    ...
    t.extend(qa.prototype, {
        ...
        ve: function(a) {
            a instanceof F && (this.Lb = this.Yc.aj(a, this.Fb), this.Me = F.aA(a) ? new F(a.lng, a.lat) : this.Yc.uh(this.Lb, this.Fb))
        },
        ue: function(a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        nb: function(a, b) {
            b = b || this.R();
            return this.Yc.nb(a, b, this.Lb, this.wb(), this.Fb)
        },
        Ua: function(a, b) {
            b = b || this.R();
            return this.Yc.Ua(a, b, this.Lb, this.wb(), this.Fb)
        },
        af: function(a, b) {
            if (a) {
        ...
        Ap: function(a, b) {
            ...
            for (var b = b || {},
            e = [], f = 0, g = d.length; f < g; f++) e.push(this.Yc.aj(d[f], this.Fb));
            d = new Ja;
        ...
        dv: function(a) {
            ...
            this.Ab == ta && this.Yc instanceof Ka && (this.Yc.Ps = this.Fb)
        },
        ...
        Zx: function() {
            this.Tq();
            var a = this.F;
            this.na < a.qc ? this.Lc(a.qc) : this.na > a.Vc && this.Lc(a.Vc);
    ...
    function Ja(a, b) {
        a && !b && (b = a);
        this.ld = this.kd = this.od = this.nd = this.li = this.bi = n;
        a && (this.li = new F(a.lng, a.lat), this.bi = new F(b.lng, b.lat), this.od = a.lng, this.nd = a.lat, this.ld = b.lng, this.kd = b.lat)
    }
    t.object.extend(Ja.prototype, {
        ...
        pe: s("bi"),
        IG: function(a) {
            return ! (a instanceof Ja) || this.zg() || a.zg() ? o: a.od > this.od && a.ld < this.ld && a.nd > this.nd && a.kd < this.kd
        },
        Ca: function() {
            return this.zg() ? n: new F((this.od + this.ld) / 2, (this.nd + this.kd) / 2)
        },
        Zz: function(a) {
            if (! (a instanceof Ja) || Math.max(a.od, a.ld) < Math.min(this.od, this.ld) || Math.min(a.od, a.ld) > Math.max(this.od, this.ld) || Math.max(a.nd, a.kd) < Math.min(this.nd, this.kd) || Math.min(a.nd, a.kd) > Math.max(this.nd, this.kd)) return n;
            var b = Math.max(this.od, a.od),
            c = Math.min(this.ld, a.ld),
            d = Math.max(this.nd, a.nd),
            a = Math.min(this.kd, a.kd);
            return new Ja(new F(b, d), new F(c, a))
        },
        JG: function(a) {
            return ! (a instanceof F) || this.zg() ? o: a.lng >= this.od && a.lng <= this.ld && a.lat >= this.nd && a.lat <= this.kd
        },
        extend: function(a) {
            if (a instanceof F) {
                var b = a.lng,
                ...
                if (!this.od || this.od > b) this.li.lng = this.od = b;
                if (!this.ld || this.ld < b) this.bi.lng = this.ld = b;
                if (!this.nd || this.nd > a) this.li.lat = this.nd = a;
                if (!this.kd || this.kd < a) this.bi.lat = this.kd = a
            }
        },
        tv: function() {
            return this.zg() ? new F(0, 0) : new F(Math.abs(this.ld - this.od), Math.abs(this.kd - this.nd))
        }
    });
    function F(a, b) {
    ...
    B.td(function(a) {
        ...
        function(a) {
            ...
            if (a instanceof Q) b.fa[a.L] || (b.fa[a.L] = a);
                ...
                for (var d = o,
                e = 0,
                f = b.gd.length; e < f; e++) if (b.gd[e] === a) {
                    d = i;
                    break
                }
                d || b.gd.push(a)
        ...
        function(a) {
            ...
            e = b.gd.length; d < e; d++) if (b.gd[d] === a) {
                b.gd.splice(d, 1);
                break
            }
        });
        ...
        function() {
            ...
            a = 0;
            for (var d = b.gd.length; a < d; a++) b.gd[a].gh != o && (b.gd[a].remove(), b.gd[a] = n, b.gd.splice(a, 1), a--, d--)
        });
    ...
    mc.getTilesUrl = function(a, b, c) {
        ...
        this.map.ph();
        e = kc[c];
        return (jc[Math.abs(d + a) % jc.length] + "?qt=tile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + e + (6 == t.M.U ? "&color_dep=32&colors=50": "") + "&udt=20131202").replace(/-(\d+)/gi, "M$1")
    };
    var ra = new hc("\u5730\u56fe", mc, {
        tips: "\u663e\u793a\u666e\u901a\u5730\u56fe"
    }),
    ...
    pc.getTilesUrl = function(a, b) {
        var c = a.x,
        d = a.y;
        return (jc[Math.abs(c + d) % jc.length] + "?qt=tile&x=" + (c + "").replace(/-/gi, "M") + "&y=" + (d + "").replace(/-/gi, "M") + "&z=" + b + "&styles=sl" + (6 == t.M.U ? "&color_dep=32&colors=50": "") + "&udt=20131202").replace(/-(\d+)/gi, "M$1")
    };
