...
/**
 * This is the model class for table "{{pay_driver_order}}".
 *
 ...
 */
class CarPayDriverOrder extends FinanceActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('channel, trans_status, verify', 'numerical', 'integerOnly'=>true),
            ...
            array('resp_msg_fist, resp_msg_second', 'length', 'max'=>500),
            array('trans_end_time, update_time', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, order_id, channel, user_id, order_amount, trans_type, trans_time, trans_status, description, resp_tn, resp_qn, verify, trans_end_time, create_time, update_time, resp_msg_fist, resp_msg_second', 'safe', 'on'=>'search'),
        );
    }
