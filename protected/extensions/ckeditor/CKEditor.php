...
//advanced - пользователь сам определяет тулбар
    private $allowedEditorTemplates=array('full','basic','public','knowledge','advanced');
    ...
    private $filebrowserImageUploadUrl = '';
	...
	public function setfilebrowserImageUploadUrl($value)
    {
        if (!is_string($value))
            throw new CException(Yii::t(__CLASS__, 'filebrowserImageUploadUrl must be an URL'));
        $this->filebrowserImageUploadUrl = $value;
    }
    ...
    // to make the content look like if it were in your target page
        ...
        switch ($this->editorTemplate) {
            ...
            case 'basic':
                ...
                break;
            case 'knowledge':
                $options['toolbar']='Knowledge';
                break;
            case 'public':
                $options['toolbar']='Public';
                break;
            default:
