...
class BaiduStat {
    ...
    private function getSourceType($path, $referer, $currentPageVisitTime, $lastPageVisitTime) {
        ...
        $parsedPath["host"] = isset($parsedPath["host"]) ? $parsedPath["host"] : '';
        $parsedReferer["host"] = isset($parsedReferer["host"]) ? $parsedReferer["host"] : '';
    ...
    private function getPixelUrl() {
        ...
        $lastPageVisitTime = isset($_COOKIE["Hm_lpvt_" . $this->siteId]) ? (int)$_COOKIE["Hm_lpvt_" . $this->siteId] : '';

        $lastVisitTime = isset($_COOKIE["Hm_lvt_" . $this->siteId]) ? $_COOKIE["Hm_lvt_" . $this->siteId] : '';
