    ...
    protected function _initConnections()
    {
        ...
        if (!isset($this->_config['connectionStrategy'])) {
            if ($this->getConfig('roundRobin') === true) {
                $this->setConfigValue('connectionStrategy', '\\Elastica\\Connection\\Strategy\\RoundRobin');
            } else {
                $this->setConfigValue('connectionStrategy', '\\Elastica\\Connection\\Strategy\\Simple');
            }
        }
